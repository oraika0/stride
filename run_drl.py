...
def main():
    ...
    # ------------------------------------------------------------------
    # startswith: covers drsir_dd (directed variant, 2026-07-10) — DRSIR has no
    # train/test split, always goes through DRL_thread (train-while-test).
    if cfg_dict["algs_name"].startswith("drsir"):
